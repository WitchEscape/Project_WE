...
namespace MikeNspired.UnityXRHandPoser
{
    public class Magazine : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            OnValidate();
            GetComponent<XRGrabInteractable>().selectEntered.AddListener(x => OnGrab());
            GetComponent<XRGrabInteractable>().selectEntered.AddListener(x => isBeingGrabbed = false);
            GetComponent<XRGrabInteractable>().selectEntered.AddListener(x => ResetToGrabbableObject());
        }
